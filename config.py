...
# Dragonite Limits
DRAGONITE_ENCOUNTER_LIMIT = get_env_int("DRAGONITE_ENCOUNTER_LIMIT", 10000)
DRAGONITE_GMO_LIMIT = get_env_int("DRAGONITE_GMO_LIMIT", 5000)

# Scheduler Notifications
ERR_DISABLED_POLL_SECONDS = get_env_int("ERR_DISABLED_POLL_SECONDS", 600)
BANNED_POLL_SECONDS = get_env_int("BANNED_POLL_SECONDS", 900)

# Dragonite DB
DRAGONITE_DB_HOST = get_env_var("DRAGONITE_DB_HOST")
DRAGONITE_DB_PORT = get_env_int("DRAGONITE_DB_PORT")
...
SUB_DB_PORT = get_env_int("SUB_DB_PORT")
